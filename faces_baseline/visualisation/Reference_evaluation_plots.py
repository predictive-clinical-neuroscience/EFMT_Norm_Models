...
EV = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/EV_ref.nii.gz")
Kurtosis = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/kurtosis_ref.nii.gz")
Skew = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/skew_ref.nii.gz")
...
plt.axis([min(EV),max_x, 0, 50000])
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)

# inset axes....
axins = ax.inset_axes([0.22, 0.2, 0.75, 0.47])
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_f/Figures/EV_histogram.png', dpi=300)
...
plt.xlabel('Skew')
plt.ylabel('Number of models (voxels)')
plt.axis([min_x,max_x, 0, 35000])
ax.xaxis.set_major_locator(ticker.MultipleLocator(0.5))
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)

plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_f/Figures/Skew_histogram.png', dpi=300)
...
plt.xlabel('Kurtosis')
plt.ylabel('Number of models (voxels)')
plt.axis([min(Kurtosis),100, 0, 140000])
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_f/Figures/Kurtosis_histogram.png', dpi=300)
