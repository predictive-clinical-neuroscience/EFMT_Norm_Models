...
counts_df.to_csv(os.path.join('/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/NPM/counts_hist.csv'),index=False)      
...
counts_df = pd.read_csv('/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/NPM/counts_hist.csv')

counts_df_ref = pd.read_csv('/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/NPM/counts_hist.csv')['reference_counts']
counts_df_cont = pd.read_csv('/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/NPM/counts_hist.csv')['control_counts']
counts_df_clin = pd.read_csv('/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/NPM/counts_hist.csv')['clinical_counts']
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_f/Figures/deviation_count_control.png', dpi=300)
...
sns.despine()
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_f/Figures/deviation_count_control_clincial_boxplot_scat.png', dpi=300)
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_f/Figures/deviation_count_control_clincial_boxplot.png', dpi=300)
