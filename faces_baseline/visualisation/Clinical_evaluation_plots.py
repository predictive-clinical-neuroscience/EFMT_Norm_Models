...
EV = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/EV_predcl.nii.gz")
Kurtosis = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/kurtosis_predcl.nii.gz")
Skew = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_f/vox/skew_predcl.nii.gz")
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_f/Figures/EV_histogram_clinical.png', dpi=300)
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_f/Figures/Skew_histogram_clinical.png', dpi=300)
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_f/Figures//Kurtosis_histogram_clinical.png', dpi=300)
