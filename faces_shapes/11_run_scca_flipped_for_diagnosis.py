...
ptk.dataio.fileio.save(W1, os.path.join(datadir,'W_faces_shapes_diagnosis_flipped.nii.gz'), example=ex_nii, mask=mask_nii)
...
#faces_factors_scca.to_csv(os.path.join('/project_cephfs/3022017.02/projects/hansav/Run7_fs/vox/NPM/SCCA/Faces_scca_factors.csv'),index=False)      
faces_factors_scca.to_csv(os.path.join('/project_cephfs/3022017.02/projects/hansav/Run7_fs/vox/NPM/SCCA/Faces_shapes_scca_diagnosis_flipped.csv'),index=False)      
