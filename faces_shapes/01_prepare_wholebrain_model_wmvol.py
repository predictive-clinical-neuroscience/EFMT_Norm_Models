...
#########################
data_nii = []
data_nii.append(os.path.join(data_dir, 'faces_shapes_AOMIC_4D.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_HCP_S1200_4D_1.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_HCP_S1200_4D_2.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_HCP_Dev_4D.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_UKB_4D_1.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_UKB_4D_2.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_UKB_4D_3.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_UKB_4D_4.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_UKB_4D_5.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_DNS_4D_1.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_DNS_4D_2.nii.gz'))
data_nii.append(os.path.join(data_dir, 'faces_shapes_MIND_Set_4D_control_split1.nii.gz'))
