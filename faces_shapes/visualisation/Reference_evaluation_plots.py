...
EV = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_fs/vox/EV_ref.nii.gz")
Kurtosis = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_fs/vox/kurtosis_ref.nii.gz")
Skew = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_fs/vox/skew_ref.nii.gz")
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_fs/Figures/EV_histogram.png', dpi=300)
...
plt.xlabel('Skew')
plt.ylabel('Number of models (voxels)')
plt.axis([min_x,max_x, 0, 50000])
ax.xaxis.set_major_locator(ticker.MultipleLocator(0.5))
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)

plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_fs/Figures/Skew_histogram.png', dpi=300)
...
plt.xlabel('Kurtosis')
plt.ylabel('Number of models (voxels)')
plt.axis([min(Kurtosis),max(Kurtosis), 0, 230000])
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_fs/Figures/Kurtosis_histogram.png', dpi=300)
