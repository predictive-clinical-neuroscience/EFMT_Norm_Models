...
EV = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run8_fs/vox/EV_ref.nii.gz")
Kurtosis = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run8_fs/vox/kurtosis_ref.nii.gz")
Skew = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run8_fs/vox/skew_ref.nii.gz")
SMSE =load_nifti("/project_cephfs/3022017.02/projects/hansav/Run8_fs/vox/SMSE_ref.nii.gz")
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run8_fs/Figures/EV_histogram.png', dpi=300)
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run8_fs/Figures/Skew_histogram.png', dpi=300)
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run8_fs/Figures/Kurtosis_histogram.png', dpi=300)
...
plt.xlabel('SMSE')
plt.ylabel('Number of models (voxels)')
plt.axis([min(SMSE),max(SMSE), 0, 60000])
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run8_fs/Figures/SMSE_histogram.png', dpi=300)
