...
EV = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_fs/vox/EV_predcl.nii.gz")
Kurtosis = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_fs/vox/kurtosis_predcl.nii.gz")
Skew = load_nifti("/project_cephfs/3022017.02/projects/hansav/Run7_fs/vox/skew_predcl.nii.gz")
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_fs/Figures/EV_histogram_clinical.png', dpi=300)
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_fs/Figures/Skew_histogram_clinical.png', dpi=300)
...
plt.show()
fig.savefig('/project_cephfs/3022017.02/projects/hansav/Run7_fs/Figures//Kurtosis_histogram_clinical.png', dpi=300)
